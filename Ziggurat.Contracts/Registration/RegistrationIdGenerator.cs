...
namespace Ziggurat.Contracts.Registration
{
    public static class RegistrationIdGenerator
    {
        ...
        public static readonly Guid AccountNamespace = new Guid("7FD14B5A-3A35-43B3-9BE5-6033CBD6E89B");
        ...
        public static Guid NewAccountId(string login)
        {
            return GuidGenerator.Create(AccountNamespace, login);
        }
    }
}
