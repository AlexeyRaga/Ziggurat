...
The **Definition** functionality is represenred by:
  ...
  - **Ziggurat.Definition.Client** Simply a "runner" (a console app or a windows service) for the Definition functionality. It supposed to wire things up. This is the physical process where commands are received, business logic is performed, events are fired, etc.
